...
export async function GET(request: NextRequest, { params }: RouteContext) {
  ...
  const venueStats = childVenues.map((venue: any) => {
    ...
    // This month's billable recordings
  ...
  // Build daily chart data (per-venue breakdown by day for this month)
  ...
  // Populate from this month's billable published recordings
  ...
  // Aggregate daily target across all child venues
