                ...
                <div className="relative">
                  ...
                  {meshBaseUrl && exploreState !== 'unavailable' && (
                    <button
                      ...
                      className="absolute end-3 top-3 z-10 inline-flex items-center gap-1.5 rounded-full bg-black/60 px-3 py-1.5 text-xs font-medium text-[var(--timberwolf)] backdrop-blur-sm transition hover:bg-black/75 disabled:cursor-default disabled:opacity-80"
                    >
                      ...
                      exploreState === 'pending' ? (
                        ...
                        <>
                          <Compass className="h-3.5 w-3.5" /> {t('explore.cta')}
                        </>
                      )}
                    </button>
                  )}
